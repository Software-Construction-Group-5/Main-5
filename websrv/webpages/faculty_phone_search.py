   ...
   # """).format(search_query if search_query else ""))
    ...
    if search_query:
        try:
            ...
            results = search_functions.search_faculty_phone(search_query)
            print("Search performed")  # Debugging output
            search_functions.display_results(results, search_query)
        except Exception as e:
