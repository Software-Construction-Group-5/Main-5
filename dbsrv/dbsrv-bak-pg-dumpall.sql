...
--
-- Name: project_db; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE project_db WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';
...
COPY public.contacts (id, name, email, phone_number, remarks, created_at) FROM stdin;
\.
